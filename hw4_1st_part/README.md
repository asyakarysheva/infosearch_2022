...
Для запуска решения нужно указать 3 аргумента, то есть написать в терминале что-то такое: `python3 main.py путь_до_папки_с_data.json путь_до_файла_answers_embeddings.pt "запрос"`.
